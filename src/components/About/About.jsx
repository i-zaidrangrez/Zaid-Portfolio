...
const About = () => {
  return (
    <div className="h-screen flex flex-col items-center justify-center mt-20 sm:mt-0">
      ...
      <div className="w-full flex items-start justify-between py-10 pb-20 gap-20">
        <AboutLeft/>
        <AboutRight/>
      </div>
    </div>
