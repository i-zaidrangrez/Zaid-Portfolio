      ...
      <div className="h-full w-full flex items-center justify-between px-2 md:px-10 flex-wrap">
        ...
        <div className="h-full w-full md:w-1/2 flex">
            <div className="h-[50vh] w-full mb-5">
              <form className="h-full w-full flex flex-col gap-5">
                <input className="border bg-secondary-text placeholder:text-black w-full border-text placeholder:font-heading flex items-start justify-start rounded-3xl px-10 py-3" type="text" placeholder="Full Name" required />
                <input className="border bg-secondary-text placeholder:text-black w-full border-text placeholder:font-heading flex items-start justify-start rounded-3xl px-10 py-3" type="email" placeholder="Email" required />
                <input className="border bg-secondary-text placeholder:text-black w-full border-text placeholder:font-heading flex items-start justify-start rounded-3xl px-10 py-13" type="textarea" placeholder="message" />
                <button className="w-fit flex font-heading items-center justify-center bg-accent text-text py-2 px-2 gap-2 rounded shadow-2xl shadow-black">Send Message <RiSendPlaneFill /></button>
              </form>
            </div>
        </div>
      </div>
